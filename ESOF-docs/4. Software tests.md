...
Visto tratar-se de um projecto de grande dimensão apenas se dará destaque às estatísticas do *package Skyframe*.
...
O que mais se aproxima de testes de sistema são os utilizadores do *Bazel*, ou seja, também eles programadores que podém melhorar a ferramenta dando *feedback* aos responsáveis pelo projecto.
...
Neste tipo de testes, os testes unitários voltam a ter um papel de extrema relevancia, visto que estes permitem verificar o impacto das alterações.
