...
#### Incrementalidade ####
As funções só conseguem aceder à *input data* através da dependência com outros nós. Por conseguinte, o Bazel consegue criar um diagrama de fluxo desde as *input files* até às *output files* e com esta informação é possível compilar apenas os nós que precisam.
