...
Este diagrama, também conhecido como *UML package diagrams* descreve os pacotes ou pedaços do sistema divididos em agrupamentos lógicos, mostrando as dependências entre eles. Assim, o Bazel é dividido em quatro *packages*, são eles: *Command-Line Interface*, *Protocol Buffers*, *Java Native interface* e *Core*. 
